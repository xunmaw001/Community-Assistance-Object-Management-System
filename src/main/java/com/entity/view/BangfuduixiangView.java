...
public class BangfuduixiangView extends BangfuduixiangEntity implements Serializable {
	...
	*/
	...
	public BangfuduixiangView() {

	}

	public BangfuduixiangView(BangfuduixiangEntity bangfuduixiangEntity) {
		try {
			BeanUtils.copyProperties(this, bangfuduixiangEntity);
