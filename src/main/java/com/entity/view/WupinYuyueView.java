...
public class WupinYuyueView extends WupinYuyueEntity implements Serializable {
	...
	*/
	...
	private String wupinYuyueYesnoValue;
	...
	public WupinYuyueView() {

	}

	public WupinYuyueView(WupinYuyueEntity wupinYuyueEntity) {
		try {
			BeanUtils.copyProperties(this, wupinYuyueEntity);
	...
	* 获取： 交换状态的值
	*/
	public String getWupinYuyueYesnoValue() {
		return wupinYuyueYesnoValue;
	}
	/**
	* 设置： 交换状态的值
	*/
	public void setWupinYuyueYesnoValue(String wupinYuyueYesnoValue) {
		this.wupinYuyueYesnoValue = wupinYuyueYesnoValue;
	}
	...
	public String toString() {
		return "WupinYuyueView{" +
			", wupinYuyueYesnoValue=" + wupinYuyueYesnoValue +
			", wupinName=" + wupinName +
