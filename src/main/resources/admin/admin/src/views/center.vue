  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'" label='家人联系方式' prop="jiarenPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
...
|| flag=='zhiyuanzhe')"  label="性别" prop="sexTypes">
...
// 注册表 志愿者 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.jiarenPhoto)&& 'yonghu'==this.flag){
