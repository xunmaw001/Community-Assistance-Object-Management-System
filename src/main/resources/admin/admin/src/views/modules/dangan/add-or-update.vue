    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="档案标题" prop="danganName">
                       <el-input v-model="ruleForm.danganName"
                                 placeholder="档案标题" clearable  :readonly="ro.danganName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="档案标题" prop="danganName">
                           <el-input v-model="ruleForm.danganName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="档案类型" prop="danganTypes">
                        <el-select v-model="ruleForm.danganTypes" :disabled="ro.danganTypes" placeholder="请选择档案类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="档案类型" prop="danganValue">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.danganFile" label="基础病史" prop="danganFile">
                        <file-upload
                                tip="点击上传基础病史"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.danganFile" label="基础病史" prop="danganFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.danganFile"  >基础病史下载</a>
                        </el-form-item>
                    </div>
                </el-col>
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="档案详情" prop="danganContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.danganContent" label="档案详情" prop="danganContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   danganFile: [
                              { required: true, message: '基础病史不能为空', trigger: 'blur' },
                          ],
                   yonghuId: [
                   ...
                   danganContent: [
                              { required: true, message: '档案详情不能为空', trigger: 'blur' },
                          ],
                   danganDelete: [
