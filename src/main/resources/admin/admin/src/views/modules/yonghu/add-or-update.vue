    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="家人联系方式" prop="jiarenPhone">
                       <el-input v-model="ruleForm.jiarenPhone"
                                 placeholder="家人联系方式" clearable  :readonly="ro.jiarenPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="家人联系方式" prop="jiarenPhone">
                           <el-input v-model="ruleForm.jiarenPhone"
                                     placeholder="家人联系方式" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jiarenPhone: [
                              { required: true, message: '家人联系方式不能为空', trigger: 'blur' },
                          ],
                   yonghuEmail: [
