        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '档案标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.danganName" placeholder="档案标题" clearable></el-input>
                     </el-form-item>
         
                     <el-form-item :label="contents.inputTitle == 1 ? '档案类型' : ''">
                        <el-select v-model="searchForm.danganTypes" placeholder="请选择档案类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shequbangfuduixiangguanli/upload/danganMuBan.xls"
                        >批量导入档案数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('dangan','导入导出')"
