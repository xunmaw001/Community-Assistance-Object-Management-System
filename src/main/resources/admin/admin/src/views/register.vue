    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">社区帮扶对象管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <!--
                            <el-form-item v-if="jiarenPhotoFlag">
                            </el-form-item>
                            <el-form-item label="家人联系方式" class="input" v-if="tableName=='yonghu'">
                                    <file-upload
                                        tip="点击上传家人联系方式"
                                        action="file/upload"
                                        :limit="1"
                                        :multiple="true"
                                        :fileUrls="ruleForm.jiarenPhoto?$base.url+ruleForm.jiarenPhoto:''"
                                        @change="jiarenPhotoUploadChange"
                                    ></file-upload>
                           </el-form-item>
                        -->
                        ...
                        <!--
                            <el-form-item v-if="zhiyuanzhePhotoFlag">
                            </el-form-item>
                            <el-form-item label="志愿者头像" class="input" v-if="tableName=='zhiyuanzhe'">
                                    <file-upload
                                        tip="点击上传志愿者头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="志愿者邮箱" class="input" v-if="tableName=='zhiyuanzhe'">
                            <el-input v-model="ruleForm.zhiyuanzheEmail" autocomplete="off" placeholder="志愿者邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='zhiyuanzhe'">
                                <el-input v-model="ruleForm.createTime" autocomplete="off" placeholder="创建时间"  />
                           </el-form-item>
                        -->
    ...
    export default {
        data() {
            return {
                ...
                jiarenPhotoFlag:false,//用于刷新文件上传
                zhiyuanzhePhotoFlag:false,//用于刷新文件上传
            };
        },
        mounted(){
        ...
        methods: {
            ...
            jiarenPhotoUploadChange(fileUrls) {
               this.ruleForm.jiarenPhoto = fileUrls;
                if(this.jiarenPhotoFlag){
                    this.jiarenPhotoFlag=false;
                }else{
                    this.jiarenPhotoFlag=true;
                }
            },
            zhiyuanzhePhotoUploadChange(fileUrls) {
               this.ruleForm.zhiyuanzhePhoto = fileUrls;
                if(this.zhiyuanzhePhotoFlag){
                    this.zhiyuanzhePhotoFlag=false;
                }else{
                    this.zhiyuanzhePhotoFlag=true;
                }
            },
            close(){
            ...
            login() {
                            ...
                            //     return
                            // }
                            // yonghu 中的 家人联系方式 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.jiarenPhoto== null ||this.ruleForm.jiarenPhoto== "")){
                            //     this.$message.error("家人联系方式不能为空");
                            //     return
                            // }
                            ...
                            // zhiyuanzhe 中的 志愿者头像 判空处理
                            // if('zhiyuanzhe' == this.tableName && (this.ruleForm.zhiyuanzhePhoto== null ||this.ruleForm.zhiyuanzhePhoto== "")){
                            ...
                            // zhiyuanzhe 中的 创建时间 判空处理
                            // if('zhiyuanzhe' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
                            //     this.$message.error("创建时间不能为空");
                            //     return
                            // }
                this.$http({
...
<style lang="scss" scoped>
	...
	.container {
        ...
        background-image: url(/shequbangfuduixiangguanli/img/back-img-bg.jpg);
