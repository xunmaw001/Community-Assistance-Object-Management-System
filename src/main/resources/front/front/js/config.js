...
var centerMenu = [
    ...
    ,{
        name: '捐款项目留言',
        url: '../juankuanxiangmLiuyan/list.html'
    }
    ,{
        name: '物品收藏',
        url: '../wupinCollection/list.html'
    }
    ,{
        name: '物品留言',
        url: '../wupinLiuyan/list.html'
    }
    ,{
        name: '申请交换',
        url: '../wupinYuyue/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '帮扶对象',
        url: './pages/bangfuduixiang/list.html'
    },
    {
        name: '论坛',
    ...
    {
        name: '捐款项目',
        url: './pages/juankuanxiangm/list.html'
    },
    {
        name: '社区公告',
    ...
    {
        name: '物品交换',
        url: './pages/wupin/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/shequbangfuduixiangguanli/admin/dist/index.html#/login";
